...
{
    internal class PrimitiveConsoleSetForegroundColor : PrimitiveParamsName
    {
        public PrimitiveConsoleSetForegroundColor(MogwaiEngine engine, string name) : base(engine, name)
        {
