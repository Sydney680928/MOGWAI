...
{
    internal class PrimitiveTaskGetResult : PrimitiveParamsName
    {
        public PrimitiveTaskGetResult(MogwaiEngine engine, string name) : base(engine, name)
        {
        }

        public override MOGObject Clone()
        {
            var obj = new PrimitiveTaskGetResult(Engine, Name);
