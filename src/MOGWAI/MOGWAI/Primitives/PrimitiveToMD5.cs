...
{
    internal class PrimitiveToMD5 : PrimitiveParamsData
    {
        public PrimitiveToMD5(MogwaiEngine engine, string name) : base(engine, name)
        {
        ...
        {
            var obj = new PrimitiveToMD5(Engine, Name);
