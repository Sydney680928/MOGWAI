...
{
    internal class PrimitiveTaskSetResult : MOGPrimitive
    {
        public PrimitiveTaskSetResult(MogwaiEngine engine, string name) : base(engine, name)
        {
        ...
        {
            var obj = new PrimitiveTaskSetResult(Engine, Name);
