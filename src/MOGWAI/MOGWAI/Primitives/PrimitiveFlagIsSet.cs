...
{
    internal class PrimitiveFlagIsSet : PrimitiveParamsName
    {
        public PrimitiveFlagIsSet(MogwaiEngine engine, string name) : base(engine, name)
        {
        ...
        {
            var obj = new PrimitiveFlagIsSet(Engine, Name);
