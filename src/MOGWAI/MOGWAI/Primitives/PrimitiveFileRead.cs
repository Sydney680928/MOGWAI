...
{
    internal class PrimitiveFileRead : MOGPrimitive
    {
        public PrimitiveFileRead(MogwaiEngine engine, string name) : base(engine, name)
        {
        ...
        {
            var obj = new PrimitiveFileRead(Engine, Name);
        ...
        public override Task<EvalResult> EngineEval()
        {
            ...
            {
                var size = Engine.StackPopNumber();
                ...
                try
                {
                    var b = Engine.FileRead(file.Value, size.IntValue);
