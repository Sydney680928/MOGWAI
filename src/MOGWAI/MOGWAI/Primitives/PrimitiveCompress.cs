...
{
    internal class PrimitiveCompress : PrimitiveParamsData
    {
        public PrimitiveCompress(MogwaiEngine engine, string name) : base(engine, name)
        {
        ...
        {
            var obj = new PrimitiveCompress(Engine, Name);
