...
{
    internal class PrimitiveIsNotEqual : MOGPrimitive
    {
        public PrimitiveIsNotEqual(MogwaiEngine engine, string name) : base(engine, name)
        {
        ...
        {
            var obj = new PrimitiveIsNotEqual(Engine, Name);
