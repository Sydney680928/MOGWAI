...
{
    internal class PrimitiveFileRename : MOGPrimitive
    {
        public PrimitiveFileRename(MogwaiEngine engine, string name) : base(engine, name)
        {
        ...
        {
            var obj = new PrimitiveFileRename(Engine, Name);
