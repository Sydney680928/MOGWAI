...
{
    internal class PrimitiveTASKDEF : MOGPrimitive
    {
        public PrimitiveTASKDEF(MogwaiEngine engine, string name) : base(engine, name)
        {
        ...
        {
            var obj = new PrimitiveTASKDEF(Engine, Name);
