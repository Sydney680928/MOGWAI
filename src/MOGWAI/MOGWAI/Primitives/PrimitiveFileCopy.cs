...
{
    internal class PrimitiveFileCopy : MOGPrimitive
    {
        public PrimitiveFileCopy(MogwaiEngine engine, string name) : base(engine, name)
        {
        ...
        {
            var obj = new PrimitiveFileCopy(Engine, Name);
