...
{
    internal class PrimitiveSTOPLUS : MOGPrimitive
    {
        public PrimitiveSTOPLUS(MogwaiEngine engine, string name) : base(engine, name)
        {
        ...
        {
            var obj = new PrimitiveSTOPLUS(Engine, Name);
