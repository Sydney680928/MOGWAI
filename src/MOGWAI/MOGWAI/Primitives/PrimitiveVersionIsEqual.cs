...
{
    internal class PrimitiveVersionIsEqual : MOGPrimitive
    {
        public PrimitiveVersionIsEqual(MogwaiEngine engine, string name) : base(engine, name)
        {
        ...
        {
            var obj = new PrimitiveVersionIsEqual(Engine, Name);
