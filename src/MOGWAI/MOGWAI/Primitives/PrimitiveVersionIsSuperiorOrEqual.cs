...
{
    internal class PrimitiveVersionIsSuperiorOrEqual : MOGPrimitive
    {
        public PrimitiveVersionIsSuperiorOrEqual(MogwaiEngine engine, string name) : base(engine, name)
        {
        ...
        {
            var obj = new PrimitiveVersionIsSuperiorOrEqual(Engine, Name);
