...
{
    internal class PrimitiveFirst : MOGPrimitive
    {
        public PrimitiveFirst(MogwaiEngine engine, string name) : base(engine, name)
        {
        ...
        {
            var obj = new PrimitiveFirst(Engine, Name);
