...
{
    internal class PrimitiveFlagSet : PrimitiveParamsName
    {
        public PrimitiveFlagSet(MogwaiEngine engine, string name) : base(engine, name)
        {
        ...
        {
            var obj = new PrimitiveFlagSet(Engine, Name);
