...
{
    internal class PrimitiveVersionIsSuperior : MOGPrimitive
    {
        public PrimitiveVersionIsSuperior(MogwaiEngine engine, string name) : base(engine, name)
        {
        ...
        {
            var obj = new PrimitiveVersionIsSuperior(Engine, Name);
