...
{
    internal class PrimitiveToChar : PrimitiveParamsNumber
    {
        public PrimitiveToChar(MogwaiEngine engine, string name) : base(engine, name)
        {
        ...
        {
            var obj = new PrimitiveToChar(Engine, Name);
