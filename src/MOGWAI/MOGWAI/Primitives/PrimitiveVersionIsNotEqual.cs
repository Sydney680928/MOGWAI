...
{
    internal class PrimitiveVersionIsNotEqual : MOGPrimitive
    {
        public PrimitiveVersionIsNotEqual(MogwaiEngine engine, string name) : base(engine, name)
        {
        ...
        {
            var obj = new PrimitiveVersionIsNotEqual(Engine, Name);
