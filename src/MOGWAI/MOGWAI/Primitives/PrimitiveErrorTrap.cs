...
{
    internal class PrimitiveErrorTrap : MOGPrimitive
    {
        public PrimitiveErrorTrap(MogwaiEngine engine, string name) : base(engine, name)
        {
        ...
        {
            var obj = new PrimitiveErrorTrap(Engine, Name);
