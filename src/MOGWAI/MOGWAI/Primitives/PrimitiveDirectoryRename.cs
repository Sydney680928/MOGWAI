...
{
    internal class PrimitiveDirectoryRename : MOGPrimitive
    {
        public PrimitiveDirectoryRename(MogwaiEngine engine, string name) : base(engine, name)
        {
        ...
        {
            var obj = new PrimitiveDirectoryRename(Engine, Name);
