...
{
    internal class PrimitiveToSHA512 : PrimitiveParamsData
    {
        public PrimitiveToSHA512(MogwaiEngine engine, string name) : base(engine, name)
        {
        ...
        {
            var obj = new PrimitiveToSHA512(Engine, Name);
