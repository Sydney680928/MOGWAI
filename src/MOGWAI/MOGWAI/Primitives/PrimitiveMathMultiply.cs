...
{
    internal class PrimitiveMathMultiply : PrimitiveParamsNumberNumber
    {
        public PrimitiveMathMultiply(MogwaiEngine engine, string name) : base(engine, name)
        {
        ...
        {
            var obj = new PrimitiveMathMultiply(Engine, Name);
