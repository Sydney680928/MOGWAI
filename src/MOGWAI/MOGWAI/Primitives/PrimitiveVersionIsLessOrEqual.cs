...
{
    internal class PrimitiveVersionIsLessOrEqual : MOGPrimitive
    {
        public PrimitiveVersionIsLessOrEqual(MogwaiEngine engine, string name) : base(engine, name)
        {
        ...
        {
            var obj = new PrimitiveVersionIsLessOrEqual(Engine, Name);
