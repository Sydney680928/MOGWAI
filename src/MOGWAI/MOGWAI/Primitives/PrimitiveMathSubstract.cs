...
{
    internal class PrimitiveMathSubstract : PrimitiveParamsNumberNumber
    {
        public PrimitiveMathSubstract(MogwaiEngine engine, string name) : base(engine, name)
        {
        ...
        {
            var obj = new PrimitiveMathSubstract(Engine, Name);
