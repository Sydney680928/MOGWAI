...
{
    internal class PrimitiveTaskStop : PrimitiveParamsName
    {
        public PrimitiveTaskStop(MogwaiEngine engine, string name) : base(engine, name)
        {
        ...
        {
            var obj = new PrimitiveTaskStop(Engine, Name);
