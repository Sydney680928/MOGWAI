...
{
    internal class PrimitiveREPEAT : MOGPrimitive
    {
        public PrimitiveREPEAT(MogwaiEngine engine, string name) : base(engine, name)
        {
        ...
        {
            var obj = new PrimitiveREPEAT(Engine, Name);
