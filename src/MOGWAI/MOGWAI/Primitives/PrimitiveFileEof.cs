...
{
    internal class PrimitiveFileEof : PrimitiveParamsString
    {
        public PrimitiveFileEof(MogwaiEngine engine, string name) : base(engine, name)
        {
        ...
        {
            var obj = new PrimitiveFileEof(Engine, Name);
