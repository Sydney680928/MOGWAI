...
{
    internal class PrimitiveToSHA256 : PrimitiveParamsData
    {
        public PrimitiveToSHA256(MogwaiEngine engine, string name) : base(engine, name)
        {
        }
