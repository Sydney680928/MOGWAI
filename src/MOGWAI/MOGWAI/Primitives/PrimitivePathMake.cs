...
{
    internal class PrimitivePathMake : PrimitiveParamsList
    {
        public PrimitivePathMake(MogwaiEngine engine, string name) : base(engine, name)
        {
        ...
        {
            var obj = new PrimitivePathMake(Engine, Name);
        ...
        public override async Task<EvalResult> PerformOperation(MOGList list)
        {
            ...
            {
                if (list.Items[i] is MOGString @string)
                {
